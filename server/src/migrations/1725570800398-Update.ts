...
export class Update1725570800398 implements MigrationInterface {
    name = 'Update1725570800398'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`task\` ADD \`replacerId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`task\` ADD UNIQUE INDEX \`IDX_93e13dca2901275bb95c0c1765\` (\`replacerId\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`task\` DROP INDEX \`IDX_93e13dca2901275bb95c0c1765\``);
